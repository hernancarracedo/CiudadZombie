...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    de ejemplo, pero podras agregar muchos mas. */  /*[[ LISTO]]*/
	...
	new Obstaculo('imagenes/auto_verde_derecha.png', 390, 480, 30, 15, 1),
  ...
  // Los enemigos se agregaran en este arreglo.  /*[[ LISTO]]*/
  enemigos: [
...
Juego.chequearColisiones = function(x, y) {
  ...
  this.obstaculos().forEach(function(obstaculo) {
    if (this.intersecan(obstaculo, this.jugador, x, y)) {
      ...
      /*COMPLETAR, obstaculo debe chocar al jugador*/  /*[[ LISTO]]*/
	  obstaculo.chocarAlJugador(this.jugador); 
...
// acá vacia los arrays con los enemigos y obstaculos desapareciendo esos objetos de la pantalla
// el metodo lo creo para usar cuando el jugador gana o pierde y se muestra la imagen final para que 
// todos los sprite no queden flotando sobre el mensaje final.
Juego.limpiarPantalla = function() {
	this.enemigos = [];
	this.obstaculosCarretera = [];
	this.jugador.ocultar();
}
...
Juego.dibujarFondo = function() {
  ...
  if (this.terminoJuego()) {
	...
	// esta linea que sigue la agregué para evitar que al ganar se borrara el mapa pero quedaran obstaculos y enemigos visibles.
